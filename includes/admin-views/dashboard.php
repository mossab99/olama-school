...
<div class="wrap olama-school-wrap">
        ...
        <div style="display: flex; align-items: center; gap: 15px;">
            ...
            <div class="olama-notification-wrapper" style="position: relative; cursor: pointer;">
                <span class="dashicons dashicons-bell"
                    style="font-size: 24px; width: 24px; height: 24px; color: #666;"></span>
                <?php
                $unread_count = count(Olama_School_Admin::get_user_notifications($user_id, true));
                if ($unread_count > 0):
                    ?>
                    <span class="olama-notif-badge"
                        style="position: absolute; top: -5px; right: -5px; background: #d63638; color: #fff; font-size: 10px; padding: 2px 5px; border-radius: 10px; font-weight: 700;">
                        <?php echo $unread_count; ?>
                    </span>
                <?php endif; ?>

                <!-- Notification Dropdown -->
                <div class="olama-notif-dropdown"
                    style="display: none; position: absolute; top: 35px; right: 0; width: 300px; background: #fff; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.15); z-index: 1000; overflow: hidden; border: 1px solid #eee;">
                    <div
                        style="padding: 12px 15px; border-bottom: 1px solid #eee; font-weight: 700; display: flex; justify-content: space-between; align-items: center;">
                        <span><?php _e('Notifications', 'olama-school'); ?></span>
                        <a href="#" class="olama-clear-all"
                            style="font-size: 0.8em; color: #2271b1; text-decoration: none;"><?php _e('Clear All', 'olama-school'); ?></a>
                    </div>
            ...
            <div
                style="background: #fff; padding: 5px 15px; border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); font-weight: 600; color: #2271b1;">
                <?php
            ...
            <div class="olama-stats-grid"
                ...
                <div class="olama-kpi-card"
                    ...
                    <div style="color: #666; font-size: 0.85em; font-weight: 600; margin-bottom: 5px;">
                        <?php _e('My Total Plans', 'olama-school'); ?>
                    </div>
                    <div style="font-size: 1.8em; font-weight: 800; color: #1d2327;"><?php echo $teacher_stats['total']; ?>
                    </div>
                </div>
                <div class="olama-kpi-card"
                    style="background: #fff; padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #00a32a;">
                    <div style="color: #666; font-size: 0.85em; font-weight: 600; margin-bottom: 5px;">
                        <?php _e('My Approved Plans', 'olama-school'); ?>
                    </div>
                    <div style="font-size: 1.8em; font-weight: 800; color: #1d2327;">
                        <?php echo $teacher_stats['approved']; ?>
                    </div>
                </div>
                <div class="olama-kpi-card"
                    style="background: #fff; padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #dba617;">
                    <div style="color: #666; font-size: 0.85em; font-weight: 600; margin-bottom: 5px;">
                        <?php _e('My Pending Review', 'olama-school'); ?>
                    </div>
                    <div style="font-size: 1.8em; font-weight: 800; color: #1d2327;">
                        <?php echo $teacher_stats['pending']; ?>
                    </div>
                </div>
                <div class="olama-kpi-card"
                    style="background: #fff; padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #999;">
                    <div style="color: #666; font-size: 0.85em; font-weight: 600; margin-bottom: 5px;">
                        <?php _e('My Drafts', 'olama-school'); ?>
                    </div>
                    <div style="font-size: 1.8em; font-weight: 800; color: #1d2327;"><?php echo $teacher_stats['draft']; ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if ($is_admin || $is_supervisor): ?>
        <div class="olama-stats-grid"
            ...
            <div class="olama-kpi-card"
                style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #2271b1;">
            ...
            <div class="olama-kpi-card"
                style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #dba617;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <div style="color: #666; font-size: 0.9em; font-weight: 600; margin-bottom: 5px;">
            ...
            <div class="olama-kpi-card"
                style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #72aee6;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <div style="color: #666; font-size: 0.9em; font-weight: 600; margin-bottom: 5px;">
            ...
            <div class="olama-kpi-card"
                style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-left: 5px solid #00a32a;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <div style="color: #666; font-size: 0.9em; font-weight: 600; margin-bottom: 5px;">
                        ...
                        <?php if ($teacher_schedule): ?>
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                <?php foreach ($teacher_schedule as $period): ?>
                                    <div
                                        style="display: flex; items-center; justify-content: space-between; padding: 15px; background: #f9f9f9; border-radius: 8px; border-right: 4px solid #2271b1;">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 15px;">
                                            <?php if ($period->plan_status): ?>
                                                ...
                                                <a href="admin.php?page=olama-school-plans&action=edit&id=<?php echo $period->plan_id; ?>"
                                                    class="button button-small"><?php _e('View Plan', 'olama-school'); ?></a>
                                            <?php else: ?>
                                                <span style="font-size: 0.85em; color: #d63638; font-weight: 600;">
                                                    <span class="dashicons dashicons-warning" style="vertical-align: middle;"></span>
                                                    <?php _e('Missing Plan', 'olama-school'); ?>
                                                </span>
                                                <a href="admin.php?page=olama-school-plans&action=create&section_id=<?php echo $period->section_id; ?>&subject_id=<?php echo $period->subject_id; ?>&period=<?php echo $period->period_number; ?>&date=<?php echo date('Y-m-d'); ?>"
                                                    class="button button-primary button-small"><?php _e('Create Now', 'olama-school'); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 5px; flex-wrap: wrap;">
                                                <?php if (empty($data['plans'])): ?>
                                                    <span
                                                        style="color: #d63638; font-size: 0.85em; font-style: italic;"><?php _e('No plans found', 'olama-school'); ?></span>
                                                <?php else: ?>
                                                    <?php foreach ($data['plans'] as $sub_id => $status): ?>
                                                        <div style="width: 25px; height: 10px; border-radius: 2px; background: <?php echo ($status == 'approved' ? '#00a32a' : ($status == 'submitted' ? '#dba617' : '#ccc')); ?>;"
                                                            title="<?php echo esc_attr(ucfirst($status)); ?>"></div>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                    ...
                    <div style="margin-top: 20px;">
                        <?php if ($system_alerts): ?>
                            <?php foreach ($system_alerts as $alert): ?>
                                <div
                                    style="display: flex; align-items: center; gap: 15px; padding: 15px; background: <?php echo ($alert['type'] == 'error' ? '#fcf0f1' : ($alert['type'] == 'warning' ? '#fff9e7' : '#f0f6fb')); ?>; border-radius: 8px; margin-bottom: 12px; border-right: 4px solid <?php echo ($alert['type'] == 'error' ? '#d63638' : ($alert['type'] == 'warning' ? '#dba617' : '#2271b1')); ?>;">
                                    <span class="dashicons <?php echo $alert['icon']; ?>"
                                        style="color: <?php echo ($alert['type'] == 'error' ? '#d63638' : ($alert['type'] == 'warning' ? '#dba617' : '#2271b1')); ?>;"></span>
                        ...
                        <?php else: ?>
                            <div style="text-align: center; padding: 30px; color: #00a32a; font-weight: 600;">
                                <span class="dashicons dashicons-yes-alt"
                                    style="font-size: 40px; width: 40px; height: 40px; display: block; margin: 0 auto 10px;"></span>
                ...
                <div style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    ...
                    <div style="margin-top: 20px;">
                        <table class="wp-list-table widefat fixed striped"
                            ...
                            <thead>
                                <tr>
                                    <th><?php _e('Day', 'olama-school'); ?></th>
                                    <th><?php _e('Slot', 'olama-school'); ?></th>
                                    <th><?php _e('Location', 'olama-school'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                foreach ($teacher_shifts as $shift): ?>
                                    <tr>
                                        <td style="font-weight: 600;"><?php echo $days[$shift->day_of_week]; ?></td>
                                        <td><?php echo esc_html($shift->slot_label); ?><br><small><?php echo date('H:i', strtotime($shift->start_time)) . ' - ' . date('H:i', strtotime($shift->end_time)); ?></small>
                                        </td>
                                        <td><?php echo esc_html($shift->location_name); ?><br><small><?php echo esc_html($shift->area_floor); ?></small>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <?php foreach ($teacher_progress as $prog): ?>
                                <div>
                                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                        <span
                                            style="font-weight: 600; color: #2271b1;"><?php echo esc_html($prog->subject_name); ?></span>
            ...
            <?php if ($is_admin || $is_supervisor): ?>
                <div style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        ?>
                        <div
                            style="height: 18px; background: #f0f0f1; border-radius: 9px; overflow: hidden; display: flex; margin-bottom: 20px;">
                            <div style="width: <?php echo $approved_pct; ?>%; background: #00a32a; height: 100%;"
                                title="Approved"></div>
                            <div style="width: <?php echo $submitted_pct; ?>%; background: #dba617; height: 100%;"
                                title="Submitted"></div>
                        </div>
...
<div id="olama-feedback-modal"
    ...
    <div
        ...
        <p style="color: #666; font-size: 0.9em;">
            <?php _e('Please provide feedback to the teacher about why this plan needs changes.', 'olama-school'); ?>
        </p>
        <textarea id="olama-feedback-text"
            ...
            placeholder="<?php _e('Enter your comments here...', 'olama-school'); ?>"></textarea>
        <div style="display: flex; justify-content: flex-end; gap: 10px;">
            <button class="button olama-modal-cancel"><?php _e('Cancel', 'olama-school'); ?></button>
            <button id="olama-confirm-feedback-btn"
                class="button button-primary olama-modal-submit"><?php _e('Send & Request Edits', 'olama-school'); ?></button>
        </div>
    </div>
</div>

<style>
    .olama-notification-wrapper:hover .dashicons {
    ...
    .olama-notif-item:hover {
        background: #f0f6fb;
    }

    .olama-notif-item.unread {
