...
<div class="wrap olama-exam-wrap">
    <div class="olama-header-section"
        ...
        <button type="button" id="open-add-exam-modal" class="button button-primary button-large"
    ...
    <?php elseif (isset($_GET['message']) && $_GET['message'] === 'exam_deleted'): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php echo Olama_School_Helpers::translate('Exam deleted successfully.'); ?></p>
        </div>
    <?php endif; ?>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php foreach ($exams as $exam):
                        ...
                        ?>
                        <tr>
                            <td><strong><?php echo esc_html($evaluation_types[$exam->evaluation_type] ?? $exam->evaluation_type); ?></strong>
                            </td>
                            <td><?php
        ...
        <div class="olama-modal-content">
            ...
            <form id="exam-form" method="post">
                ...
                <div class="olama-form-grid">
                    ...
                    <div class="form-field full-width">
                        ...
                        <textarea name="description" required rows="3"
                            placeholder="<?php echo Olama_School_Helpers::translate('Detailed exam description...'); ?>"></textarea>
                    </div>
                ...
                <div class="olama-modal-footer">
                    ...
                    <button type="submit" name="apply_new" id="apply-new-btn"
                        class="button button-secondary"><?php echo Olama_School_Helpers::translate('Apply and Add New'); ?></button>
