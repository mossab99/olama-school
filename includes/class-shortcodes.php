...
class Olama_School_Shortcodes
{
    ...
    public function render_exam_report_shortcode($atts)
    {
        ...
        <div class="olama-weekly-plan-v2 olama-exam-report-v2">
                    ...
                    <div class="day-item <?php echo $is_active; ?>">
                        <div class="day-header">
                            ...
                            <div class="day-date-badge" style="background: linear-gradient(145deg, #6366f1 0%, #4f46e5 100%);">
                                <span
                                    class="date-month"><?php echo strtoupper(Olama_School_Helpers::format_date($date, false, 'M')); ?></span>
                                <span class="date-day"><?php echo Olama_School_Helpers::format_date($date, false, 'd'); ?></span>
                            </div>
                        </div>
                        <div class="day-content">
                                ...
                                <div class="subject-card"
                                    ...
                                    <div class="detail-list" style="margin-bottom: 15px;">
                                        <?php if ($exam->room_number || $exam->master_room): ?>
                                            <div class="detail-item">
                                                ...
                                                <span
                                                    class="detail-label"><?php echo Olama_School_Helpers::translate('القاعة/الغرفة'); ?>:</span>
                                                <span
                                                    class="detail-value"><?php echo esc_html($exam->room_number ?: $exam->master_room); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="section-block classwork"
                                        ...
                                        <div class="section-label" style="color: #4f46e5;">
                                            ...
                                            <?php echo Olama_School_Helpers::translate('مادة الاختبار'); ?>
                                        </div>
                                        ...
                                        <div class="detail-list">
                                            ...
                                            if (!empty($material['curriculum_items'])):
                                                foreach ($material['curriculum_items'] as $item): ?>
                                                    <div class="detail-item"
                                                        ...
                                                        <span
                                                            class="detail-value"><?php echo esc_html($item['unit'] . ' - ' . $item['lesson']); ?></span>
                                                    </div>
                                                <?php endforeach;
                                            endif; ?>
                                            ...
                                            <?php if ($exam->student_book_material): ?>
                                                <div class="detail-item">
                                                    ...
                                                    <span
                                                        class="detail-label"><?php echo Olama_School_Helpers::translate('Student Book'); ?>:</span>
                                                    <span class="detail-value"><?php echo esc_html($exam->student_book_material); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if ($exam->workbook_material): ?>
                                                <div class="detail-item">
                                                    ...
                                                    <span
                                                        class="detail-label"><?php echo Olama_School_Helpers::translate('Workbook'); ?>:</span>
                                                    <span class="detail-value"><?php echo esc_html($exam->workbook_material); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            if (!empty($booklets_val)): ?>
                                                <div class="detail-item">
                                                    ...
                                                    <span
                                                        class="detail-label"><?php echo Olama_School_Helpers::translate('Booklets & Notebooks'); ?>:</span>
                                                    <span class="detail-value"><?php echo esc_html($booklets_val); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    if (!empty($notes_val)): ?>
                                        <div class="section-block teacher-notes"
                                            ...
                                            <div class="section-label" style="color: #b45309;">
                                                ...
                                                <?php echo Olama_School_Helpers::translate('ملاحظات هامة'); ?>
                                            </div>
            ...
            <script>
                        // Use a namespace-safe approach or reuse existing logic if load           ed
                        jQuery(document).ready(function ($) {
                            $('.olama-exam-report-v2 .day-header').on('click', function () {
                                const item = $(this).closest('.day-item');
                                const wasActive = item.hasClass('active');

                                $('.olama-exam-report-v2 .day-item').removeClass('active');
                                if (!wasActive) {
                                ...
                                <div class="exam-card">
                                    <div class="exam-card-header" onclick="this.parentElement.classList.toggle('active')">
                                        <div class="subject-info">
                                            ...
                                            <span class="subject-name"><?php echo $subject ? esc_html($subject->subject_name) : ''; ?></span>
                                        </div>
                                        <div class="exam-meta">
                                            <span class="exam-date"><?php echo $formatted_date; ?></span>
                                    ...
                                    <div class="exam-card-content">
                                        <?php if ($ex->room_number): ?>
                                                <div class="detail-row room">
                                                    <span class="label"><?php echo Olama_School_Helpers::translate('Room'); ?>:</span>
                                                    <span class="value"><?php echo esc_html($ex->room_number); ?></span>
                                                </div>
                                        <?php endif; ?>
