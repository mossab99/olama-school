...
class Olama_School_Helpers
{
    ...
    public static function translate($text)
    {
        ...
        // Exam Hall Distribution
        'Exam Hall Distribution' => 'توزيع قاعات الاختبار',
        'Exam Hall Distribution System' => 'نظام توزيع قاعات الاختبار',
        'Halls' => 'القاعات',
        'Distribution' => 'التوزيع',
        'Assigned' => 'موزعون',
        'Unassigned' => 'غير موزعين',
        'Total Capacity' => 'إجمالي السعة',
        'Auto Distribute' => 'توزيع تلقائي',
        'Clear All' => 'مسح التوزيع',
        'Manage Exam Halls' => 'إدارة قاعات الاختبار',
        'Add Hall' => 'إضافة قاعة',
        'Hall Name' => 'اسم القاعة',
        'Behavior Notes' => 'الملاحظات السلوكية',
        'Attendance saved successfully.' => 'تم حفظ الحضور بنجاح.',
        'Note saved.' => 'تم حفظ الملاحظة.',
        'Student moved successfully.' => 'تم نقل الطالب بنجاح.',
        'All assignments cleared.' => 'تم مسح جميع التوزيعات.',
        ...
        'Please select a grade and section to view students.' => 'يرجى اختيار الصف والشعبة لعرض الطلاب.',
        'Select Grade First' => 'اختر الصف أولاً',
        'Student Family Report' => 'تقرير عائلات الطلاب',
        ...
        'Invalid Academic Year.' => 'العام الدراسي المحدد غير صالح.',
        'The selected section does not belong to the selected academic year.' => 'الشعبة المحددة لا تتبع العام الدراسي المحدد.',
        'The selected section does not belong to the selected grade.' => 'الشعبة المحددة لا تتبع الصف المحدد.',
        'Invalid week date.' => 'تاريخ الأسبوع غير صالح.',
        'The selected week does not belong to the selected semester.' => 'الأسبوع المحدد لا يتبع الفصل الدراسي المحدد.',
