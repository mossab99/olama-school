...
class Olama_School_Helpers
{
    ...
    public static function translate($text)
    {
        ...
        'Plan Review' => 'مراجعة الخطة',
        'Feedback' => 'الملاحظات',
        'Review Submitted Plans' => 'مراجعة الخطط المسلمة',
        'Plans awaiting review' => 'خطط تنتظر المراجعة',
        'No plans awaiting review.' => 'لا توجد خطط تنتظر المراجعة.',
