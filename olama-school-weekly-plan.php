 ...
 * Version: 2.8.0
 * Requires Plugins: olama-core, olama-users, olama-exam-management, olama-transportation, olama-kg, olama-student-evaluation, olama-supervision, olama-employees, olama-media-library
...
define('OLAMA_SCHOOL_VERSION', isset($matches[1]) ? trim($matches[1]) : '2.8.0');
